...
print("=" * 80)
print("🔍 GRIDSEARCHCV — ЛОГИСТИЧЕСКАЯ РЕГРЕССИЯ И LINEARSVC")
print("=" * 80)
...
with open('results_lr_grid.json', 'w', encoding='utf-8') as f:
...
with open('results_linearsvc_grid.json', 'w', encoding='utf-8') as f:
...
print("\n✅ Результаты сохранены: results_lr_grid.json, results_linearsvc_grid.json")
